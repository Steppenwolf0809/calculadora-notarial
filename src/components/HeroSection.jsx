      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 min-h-screen flex items-center">
        <div className="text-center max-w-3xl mx-auto text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <Button 
              onClick={onShowForm}
              className="bg-white text-primary hover:bg-gray-100 text-lg px-8 py-4 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
            >
              Consulta Gratuita
            </Button>
          </div>
          ...
          <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            <div className="bg-black/20 backdrop-blur-sm rounded-lg p-6 transform hover:-translate-y-1 transition-all duration-200 border border-white/10 hover:border-accent/30">
